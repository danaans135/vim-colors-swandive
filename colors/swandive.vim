...
let g:colors_name="swandive"

if exists("g:swandive_original")
    let s:swandive_original = g:swandive_original
else
    let s:swandive_original = 0
endif
...
hi Statement       guifg=#4477F2               gui=none
hi StatusLine      guifg=#455384 guibg=fg
...
hi VisualNOS                     guibg=#2020b0
hi Visual                        guibg=#2020b0
hi WarningMsg      guifg=#FFFFFF guibg=#333333 gui=bold
hi WildMenu        guifg=#66D9EF guibg=#000000

if s:swandive_original == 1
   ...
   hi LineNr          guifg=#808080 guibg=#303030
